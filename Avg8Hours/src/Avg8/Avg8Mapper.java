...
public class Avg8Mapper extends Mapper<LongWritable, Text, Text, Text> {
	public void map(LongWritable key, Text value, Context context)   throws IOException, InterruptedException {
		...
		try {
			...
			// In this project we send to reducer all values. Missing values
			// will be handled in reducer.
